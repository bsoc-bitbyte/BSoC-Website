    ...
    <div class="accordion" id="accordionExample">
      ...
      <div class="accordion-item bg-black">
        <h2 class="accordion-header" id="headingFive">
          <button class="accordion-button bg-black collapsed" type="button" style="color: #ffffff"
            data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFour">
      ...
      <div class="accordion-item bg-black">
        <h2 class="accordion-header" id="headingSeven">
          <button class="accordion-button bg-black collapsed" type="button" style="color: #ffffff"
            data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSix">
